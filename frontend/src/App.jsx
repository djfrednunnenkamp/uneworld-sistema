  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
        ...
        <Route path="roteiros"            element={<RequirePermission><Itineraries     /></RequirePermission>} />
        <Route path="roteiros/:id"        element={<RequirePermission><ItineraryDetail /></RequirePermission>} />
