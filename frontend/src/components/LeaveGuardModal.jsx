...
/** "Realmente deseja sair?" — alterações não salvas. Descartar (apaga) ou Salvar.
 * Props: onDiscard, onSave, onStay, saving, entity ('passageiro'|'agência'|...) */
export default function LeaveGuardModal({ onDiscard, onSave, onStay, saving = false, entity = 'cadastro' }) {
  return (
