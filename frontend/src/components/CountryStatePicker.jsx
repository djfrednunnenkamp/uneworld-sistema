...
export default function CountryStatePicker({ country, state, onChangeCountry, onChangeState }) {
  ...
  /* fecha ao clicar fora — usa fase de captura: ao escolher um país, o passo
     muda (país → estado) e a lista é re-renderizada antes da fase de bolha
     chegar ao document, removendo o elemento clicado do DOM e fazendo o
     "contains" abaixo retornar falso (fechando o popup por engano) */
  useEffect(() => {
