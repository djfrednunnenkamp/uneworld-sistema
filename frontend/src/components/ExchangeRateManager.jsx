...
function ScriptDocsModal({ onClose }) {
  ...
  return (
    <div onClick={e => { if (e.target === e.currentTarget) onClose() }}
      ...
      <div onClick={e => e.stopPropagation()} style={{ background:'#fff', borderRadius:12, width:'100%', maxWidth:780, maxHeight:'88vh', display:'flex', flexDirection:'column', boxShadow:'0 24px 64px rgba(0,0,0,.3)', overflow:'hidden' }}>
        ...
        <div style={{ border:'1px solid #e2e8f0', borderRadius:8, overflow:'hidden' }}>
          {filtered.length === 0 ? (
            ...
            <div key={item.id} style={{
              display:'grid', gridTemplateColumns:'minmax(0,1fr) 340px auto', alignItems:'center', gap:12,
              ...
              <span style={{ fontWeight:500, display:'flex', alignItems:'center', flexWrap:'wrap', gap:7, rowGap:5, minWidth:0 }}>
                {canEdit && (
