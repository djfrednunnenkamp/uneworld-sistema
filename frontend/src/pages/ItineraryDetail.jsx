            ...
            <div style={{ display: 'flex', gap: 10, alignItems: 'center', marginBottom: data.payment_plan ? 12 : 0, flexWrap: 'wrap' }}>
              ...
              {!data.payment_plan
                ? <button type="button" disabled={!canEdit}
                    onClick={() => setData(d => ({ ...d, payment_plan: { a_vista: false, has_down_payment: false, down_payment_mode: 'percent', down_payment_value: '', down_payment_method: '', down_payment_rounding: 0.01, installments_count: '', payment_method: '', installment_rounding: 0.01, first_due_days: 30, interval_days: 30 } }))}
