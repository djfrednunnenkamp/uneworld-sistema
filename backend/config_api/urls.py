...
router.register('terrestres',            views.TerrestreViewSet,          basename='config-terrestre')
router.register('terrestre-media',       views.TerrestreMediaViewSet,     basename='terrestre-media')
