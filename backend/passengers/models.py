...
class Passenger(models.Model):
    ...
    passport_country  = models.CharField('País do passaporte', max_length=10, blank=True)
    ...
    passport2         = models.CharField('Segundo passaporte', max_length=50, blank=True)
    passport2_country = models.CharField('País do 2º passaporte', max_length=10, blank=True)
...
class PassengerDocument(models.Model):
    ...
    doc_model     = models.CharField('Modelo do documento', max_length=20, blank=True)
    doc_category  = models.CharField('Categoria / Classe', max_length=20, blank=True)  # ex: classe da CNH
