...
PERMISSION_FIELDS = [
    ...
    'settings_professions_view', 'settings_professions_edit', 'settings_professions_delete',
    'settings_languages_view', 'settings_languages_edit', 'settings_languages_delete',
    'settings_countries_view', 'settings_countries_edit', 'settings_countries_delete',
    'settings_genders_view', 'settings_genders_edit', 'settings_genders_delete',
    'settings_vaccines_view', 'settings_vaccines_edit', 'settings_vaccines_delete',
    'settings_doc_types_view', 'settings_doc_types_edit', 'settings_doc_types_delete',
    'settings_prof_cards_view', 'settings_prof_cards_edit', 'settings_prof_cards_delete',
    'settings_user_profiles_view', 'settings_user_profiles_edit', 'settings_user_profiles_delete',
    'settings_list_additionals_view', 'settings_list_additionals_edit', 'settings_list_additionals_delete',
    'settings_crew_roles_view', 'settings_crew_roles_edit', 'settings_crew_roles_delete',
    'settings_accommodations_view', 'settings_accommodations_edit', 'settings_accommodations_delete',
    'settings_list_categories_view', 'settings_list_categories_edit', 'settings_list_categories_delete',
    'settings_airports_view', 'settings_airports_edit', 'settings_airports_delete',
    'settings_airlines_view', 'settings_airlines_edit', 'settings_airlines_delete',
