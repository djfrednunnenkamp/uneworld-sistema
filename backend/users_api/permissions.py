...
PERMISSION_FIELDS = [
    ...
    'settings_exchange_rates_view', 'settings_exchange_rates_edit', 'settings_exchange_rates_delete', 'settings_exchange_rates_advanced', 'settings_exchange_rates_rounding', 'settings_exchange_rates_bulk_import', 'settings_exchange_rates_export',
